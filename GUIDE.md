...
> **Welcome to Product-Track Week 9, Hotfix 2!**
...
1. **Read the comments** at the top of `flakyTest.js` - they describe the problem
...
| File | Purpose |
|------|---------|
| `flakyTest.js` | The code with bugs - **fix this file** |
...
### Bug #1
**User Report / Alert:**
> "The test relies on setTimeout completing in exactly 100ms,"
...
### Bug #2
**User Report / Alert:**
> "This setTimeout relies on exact 100ms timing."
...
### Bug #3
**User Report / Alert:**
> "Strict equality check — should allow for timing variance"
...
1. **Read the top comment block** in `flakyTest.js` carefully - it has:
